  ...
  Widget build(BuildContext context) {
    var calc = SimpleCalculator(
      ...
      theme: const CalculatorThemeData(
        ...
        displayStyle: TextStyle(fontSize: 80, color: Colors.blue),
        expressionColor: Colors.blue,
        expressionStyle: TextStyle(fontSize: 20, color: Colors.white),
        operatorColor: Colors.black,
        operatorStyle: TextStyle(fontSize: 30, color: Colors.white),
        commandColor: Colors.blueGrey,
        commandStyle: TextStyle(fontSize: 30, color: Colors.red),
        numColor: Color.fromARGB(255, 206, 206, 206),
        numStyle: TextStyle(fontSize: 50, color: Colors.black38),
      ),
    );
